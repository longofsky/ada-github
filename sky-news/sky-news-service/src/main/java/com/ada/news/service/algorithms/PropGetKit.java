...
public class PropGetKit
{
	...
	public static void loadProperties(String configFileName)
	{
		try
		{
			propGetKit.load(new FileInputStream(System.getProperty("user.dir") + "/ada-news/ada-news-provider/res/" + configFileName + ".properties"));
		}
	...
	{
		if(propGetKit.isEmpty() || propGetKit.size() <= 0) {

			loadProperties("paraConfig");
		}
